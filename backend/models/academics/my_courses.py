...
class OfficeHourTicketOverview(BaseModel):
    ...
    state: str
    type: str
    concept_help_description: str | None  # conceptual help
    assignment_section_description: str | None  # assignment help
    code_to_english_description: str | None  # assignment help
    concepts_needed_description: str | None  # assignment help
    tactics_tried: str | None  # assignment help
    meeting_summary: str | None
    solutions_used: str | None
    concepts_for_review: str | None
    caller: PublicUser | None
    caller_id: int | None
    office_hours_id: int  # test
