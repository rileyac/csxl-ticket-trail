...
import { TicketSummaryCardWidget } from './course/office-hours/widgets/ticket-summary-card/ticket-summary-card.widget';
import { SimilarTicketsPageComponent } from './course/office-hours/similar-tickets-page/similar-tickets-page.component';
...
@NgModule({
  declarations: [
    ...
    TicketSummaryCardWidget,
    SimilarTicketsPageComponent
  ],
  imports: [
    CommonModule,
