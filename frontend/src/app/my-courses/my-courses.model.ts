...
export interface OfficeHourTicketOverviewJson {
  ...
  type: number;
  // description: string;
  concept_help_description: string | undefined; //conceptual help
  assignment_section_description: string | undefined; //assignment help
  code_to_english_description: string | undefined; //assignment help
  concepts_needed_description: string | undefined; //assignment help
  tactics_tried: string | undefined; //assignment help
  meeting_summary: string | undefined; //TA response
  solutions_used: string | undefined; //TA response
  concepts_for_review: string | undefined; //TA response
...
export interface OfficeHourTicketTAResponse {
  meeting_summary: string | undefined; //TA response
  solutions_used: string | undefined; //TA response
  concepts_for_review: string | undefined;
}
