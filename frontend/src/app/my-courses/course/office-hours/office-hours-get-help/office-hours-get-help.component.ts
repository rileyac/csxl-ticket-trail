...
export class OfficeHoursGetHelpComponent implements OnInit, OnDestroy {
  ...
  submitTicketForm() {
    ...
    let concept_help_description: string = '';
    let assignment_description: string = '';
    let code_description: string = '';
    let concepts_needed_description: string = '';
    let tactics_tried: string = '';
    ...
    */
    ...
    let ticketDraft: TicketDraft = {
      ...
      concept_help_description: concept_help_description,
      assignment_section_description: assignment_description,
      code_to_english_description: code_description,
      concepts_needed_description: concepts_needed_description,
